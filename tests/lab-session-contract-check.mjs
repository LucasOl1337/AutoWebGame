...
assertIncludes(gameApp, "pushLabTelemetry", "game-app.ts telemetry activation");
assertIncludes(gameApp, "AutoImprovementBridge.pushTelemetry", "game-app.ts telemetry dispatch");
