...
p1.maxBombs = MAX_BOMBS;
p1.position = { x: 2.5 * TILE_SIZE, y: 1.5 * TILE_SIZE };
p1.tile = { x: 2, y: 1 };
game.collectPowerUps();
const preservedForOtherPlayer = !powerUp.collected;
p1.maxBombs = MAX_BOMBS - 1;
game.collectPowerUps();
const collectedWhenUseful = powerUp.collected && p1.maxBombs === MAX_BOMBS;
const report = { preservedForOtherPlayer, collectedWhenUseful, pass: preservedForOtherPlayer && collectedWhenUseful };
