...
const contractCases = [
  ...
  ["/api/admin/summary", "POST", true, "/internal/admin/summary"],
  ...
  ["/api/admin/arenas/live-arena", "POST", true, "/internal/admin/arenas/live-arena"],
  ["/api/admin/arenas/live-arena/validate", "POST", true, "/internal/admin/arenas/live-arena/validate"],
  ["/api/admin/arenas/live-arena/validate", "PUT", true, "/internal/admin/arenas/live-arena/validate"],
  ["/api/admin/arenas/live-arena/activate", "POST", true, "/internal/admin/arenas/live-arena/activate"],
  ["/api/admin/arenas/live-arena/activate", "GET", true, "/internal/admin/arenas/live-arena/activate"],
  ...
  ["/api/me", "GET", true, "/internal/account/me"],
  ["/api/account/quick-create", "POST", true, "/internal/account/quick-create"],
  ["/api/logout", "POST", true, "/internal/account/logout"],
