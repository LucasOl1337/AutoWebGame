...
export const SITE_COPY: Record<SiteLanguage, SiteCopy> = {
  pt: {
    ...
    canvas: {
      ...
      roundStartSubtitle: "Seja o ultimo bomber vivo.",
      arenaRebooting: "Arena reiniciando...",
      doubleKo: "Eliminacao simultanea: os dois nucleos explodiram.",
  ...
  en: {
    ...
    canvas: {
      ...
      roundStartSubtitle: "Be the last bomber alive.",
      arenaRebooting: "Arena rebooting...",
      doubleKo: "Simultaneous elimination: both cores overloaded.",
